...
One can think of why the gradient descent works. If the loss function is convex means it has "U" shape as shown in the figure below, the "gradient" at a point is the "direction and rate of fastest increase".
...
as a function of theta in this `code <>`_.
